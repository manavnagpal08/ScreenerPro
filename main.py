...
/* If the GitHub button is separate and has a unique class, add it here. */
/* Example (purely illustrative, confirm actual class if data-testid doesn't work): */
/* .github-button-class {{ display: none !important; visibility: hidden !important; }} */
