...
# This entire markdown block will contain both global styles and dynamic dark mode styles
st.markdown(f"""
...
/* Ensure text in sidebar, titles, headers, etc. is readable */
...
/* --- Hiding Specific Streamlit UI elements (kept from previous version) --- */
    ...
    if not df_results.empty:
        try:
            ...
            with col_g1:
                ...
                ax1.pie(pie_data['Count'], labels=pie_data['Tag'], autopct='%1.1f%%', startangle=90, textprops={'fontsize': 10, 'color': 'white' if dark_mode else 'black'})
                ax1.axis('equal')
                fig_pie.patch.set_facecolor('none') # Make background of plot transparent
            ...
            with col_g2:
                ...
                fig_bar.patch.set_facecolor('none') # Make background of plot transparent
            ...
            if 'Matched Keywords' in df_results.columns:
                ...
                if not skill_counts.empty:
                    ...
                    fig_skills.patch.set_facecolor('none') # Make background of plot transparent
