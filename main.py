...
st.markdown("""
<style>
/* ✅ Hide top GitHub Fork button (if present) */
button[title="Fork"] {
...
/* ✅ Hide profile avatar and preview bubble */
...
/* ✅ Hide Streamlit decoration and portal */
div[data-testid="stDecoration"],
#portal {
    display: none !important;
}

/* ✅ Also hide Streamlit Cloud badge that appears late */
div[class*="st-emotion-cache"][style*="absolute"] {
    display: none !important;
    visibility: hidden !important;
}

/* ✅ Optional: prevent badge container taking space */
.css-1dp5vir.ezrtsby0 {
    display: none !important;
    height: 0px !important;
    visibility: hidden !important;
}
